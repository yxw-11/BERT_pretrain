...
''' erix added: (pretty old)
# cd "$DOCS"
# cd ~/Documents/JHU" "2021" "Summer-Capstone/bert-master
## use * to replace
export BERT_BASE_DIR="/Users/sirerix/Documents/JHU 2021 Summer-Capstone/bert-master/vocab_from_bert_large"
python create_pretraining_data.py \
  --input_file=./sample_text.txt \
  --output_file=tmp/sth2.txt\
